...
const ProfileControls = ({ config, onChange }) => {
  ...
  return (
    <motion.div
      ...
      className="fixed left-4 top-4 bottom-4 w-80 bg-white rounded-lg shadow-2xl z-50 overflow-hidden"
    >
      <div className="h-full flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-6">
          {/* Item Type */}
          <div>
            <Label className="text-sm font-medium text-gray-700 mb-3 block">Item-Typ</Label>
          ...
          {/* Navigation Type */}
          <div>
            <Label className="text-sm font-medium text-gray-700 mb-3 block">Navigation</Label>
            <div className="space-y-2">
          ...
          {/* Components */}
          <div>
            <Label className="text-sm font-medium text-gray-700 mb-3 block">Subkomponenten</Label>
