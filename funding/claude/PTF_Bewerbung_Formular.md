# Prototype Fund Bewerbung - Real Life Stack
...
### GitHub-Account der Hauptansprechperson
https://github.com/ulfgebhardt

---

## 2. Projektbeschreibung (100 Wörter)
...
## 3. Gesellschaftliche Herausforderung (175 Wörter)
...
## 4. Technische Umsetzung (175 Wörter)
...
Für Identitäten setzen wir auf schlüsselbasierte Accounts, die optional als Decentralized Identifiers (DIDs) abgebildet werden können. Ein einfaches Web-of-Trust-Modell ermöglicht Vertrauensbeziehungen durch Einladungen und gegenseitige Bestätigungen.

---

## 5. Aktueller Stand (100 Wörter)
...
## 9. Meilensteine (100 Wörter)

**M1 (Monate 1-2): Architektur & Grundlagen**
- Definition der Daten- und Identitätsschnittstelle
- Connector-Struktur mit Referenz-Connector (REST/GraphQL)
- Projekt-Setup (Monorepo, TypeScript, Testing-Framework)
- Dokumentationsstruktur (Developer Docs)
...
- **Mathias Lenz** (https://github.com/mahula): Full-Stack-Entwickler mit Fokus auf Frontend und UX
- **Sebastian Stein** (https://github.com/sebastian2357): Backend-Entwicklung und Infrastruktur
- **Anton Tranelis** (https://github.com/antontranelis): System-Architektur und Identitätssysteme
- **Ulf Gebhardt** (https://github.com/ulfgebhardt): DevOps, Cloud-Infrastruktur und Integration

---

## 11. Erfahrung (100 Wörter)
...
- Erfahrung mit Self-Hosting-Infrastruktur (Authentik, Keycloak)
- Consultant für moderne Web-Technologien (Vue 3, Nuxt, TypeScript, Tailwind)
...
1.900 Stunden (6 Monate, 4 Personen à ~475 Stunden)

---

## 13. Motivation (100 Wörter)
...
Uns treibt die Vision einer dezentralen, selbstbestimmten digitalen Welt an, in der Gemeinschaften Kontrolle über ihre Daten haben und Tools nutzen können, die echte Begegnungen fördern statt verhindern.
...
## 15. Second Stage: Schwerpunkt (175 Wörter)
...
- Präsentation auf Konferenzen und in relevanten Communities
- Erstellung von Best-Practice-Guides für weitere Gruppen

---

## 16. Second Stage: Meilensteine (100 Wörter)
...
- Lebensmittelverteilungs-Modul (optional)
...
- Community-Support-Konzept etablieren

**M4 (Monate 13-14): Impact-Messung**
- Dokumentation der Erkenntnisse
- Erfolgsmessung: Wie viele Communities nutzen den Stack aktiv?
...
✅ Ich bin damit einverstanden, die Projektergebnisse unter einer Open-Source-Lizenz (MIT oder Apache 2.0), öffentlich zugänglich über GitHub zur Verfügung zu stellen.
...
**Frontend:**
- TypeScript
- React oder Vue.js (finale Entscheidung in M1)
- Leaflet/MapLibre für Karten
- Tailwind CSS für Styling
- Vitest für Testing

**Backend (Referenz-Implementierung):**
- Node.js mit Express oder Fastify
- PostgreSQL mit PostGIS für Geo-Daten
- Optional: CalDAV-Server für Kalender-Synchronisation
- Docker & Docker Compose für Deployment

**Standards & Protokolle:**
- OAuth 2.0 / OpenID Connect für Identität
- iCal für Kalender-Export
- Optional: ActivityPub für Federation (Second Stage)

### Lizenz
MIT oder Apache 2.0 (finale Entscheidung im Team vor Projektstart)

---

**Kontakt:**
IT4C (IT Team For Change)
E-Mail: ptf@it4c.dev
GitHub: https://github.com/IT4Change